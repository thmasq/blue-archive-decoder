...
impl MemoryLobbyCategory {
    ...
    pub const ENUM_VALUES: &'static [Self] =
        &[Self::None, Self::UILobbySpecial, Self::UILobbySpecial2];
...
impl<'de> serde::Deserialize<'de> for MemoryLobbyCategory {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in MemoryLobbyCategory::ENUM_VALUES {
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown MemoryLobbyCategory variant: {s}"
        )))
    }
}
