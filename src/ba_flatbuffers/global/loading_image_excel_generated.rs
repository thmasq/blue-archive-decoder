...
impl<'a> LoadingImageExcel<'a> {
    ...
    pub const VT_IMAGE_PATH_KR: ::flatbuffers::VOffsetT = 6;
    pub const VT_IMAGE_PATH_JP: ::flatbuffers::VOffsetT = 8;
    pub const VT_DISPLAY_WEIGHT: ::flatbuffers::VOffsetT = 10;
    pub const VT_IMAGE_PATH_TH: ::flatbuffers::VOffsetT = 12;
    pub const VT_IMAGE_PATH_TW: ::flatbuffers::VOffsetT = 14;
    pub const VT_IMAGE_PATH_EN: ::flatbuffers::VOffsetT = 16;
    ...
    pub fn id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(LoadingImageExcel::VT_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn image_path_kr(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                LoadingImageExcel::VT_IMAGE_PATH_KR,
                None,
            )
        }
    }
    ...
    pub fn image_path_jp(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                LoadingImageExcel::VT_IMAGE_PATH_JP,
                None,
            )
        }
    }
    #[inline]
    pub fn display_weight(&self) -> i32 {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<i32>(LoadingImageExcel::VT_DISPLAY_WEIGHT, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn image_path_th(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                LoadingImageExcel::VT_IMAGE_PATH_TH,
                None,
            )
        }
    }
    ...
    pub fn image_path_tw(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                LoadingImageExcel::VT_IMAGE_PATH_TW,
                None,
            )
        }
    }
    ...
    pub fn image_path_en(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                LoadingImageExcel::VT_IMAGE_PATH_EN,
                None,
            )
        }
    }
...
impl ::flatbuffers::Verifiable for LoadingImageExcel<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<i32>("display_weight", Self::VT_DISPLAY_WEIGHT, false)?
            .visit_field::<::flatbuffers::ForwardsUOffset<&str>>(
                "image_path_th",
...
impl Serialize for LoadingImageExcel<'_> {
        ...
        S: Serializer,
    {
        ...
        s.serialize_field("display_weight", &self.display_weight())?;
...
impl ::core::fmt::Debug for LoadingImageExcel<'_> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        ...
        ds.field("display_weight", &self.display_weight());
