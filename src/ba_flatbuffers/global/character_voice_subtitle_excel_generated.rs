...
impl<'a> CharacterVoiceSubtitleExcel<'a> {
    ...
    pub fn localize_cv_group(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                CharacterVoiceSubtitleExcel::VT_LOCALIZE_CV_GROUP,
                None,
            )
        }
    }
    ...
    pub fn character_voice_group_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(
                    CharacterVoiceSubtitleExcel::VT_CHARACTER_VOICE_GROUP_ID,
                    Some(0),
                )
                .unwrap()
        }
    ...
    pub fn tlmid(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                CharacterVoiceSubtitleExcel::VT_TLMID,
                None,
            )
        }
    }
    ...
    pub fn duration(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(CharacterVoiceSubtitleExcel::VT_DURATION, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn duration_kr(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(CharacterVoiceSubtitleExcel::VT_DURATION_KR, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn separate(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(CharacterVoiceSubtitleExcel::VT_SEPARATE, Some(false))
                .unwrap()
        }
    }
    #[inline]
    pub fn localize_kr(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                CharacterVoiceSubtitleExcel::VT_LOCALIZE_KR,
                None,
            )
        }
    }
    ...
    pub fn localize_jp(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                CharacterVoiceSubtitleExcel::VT_LOCALIZE_JP,
                None,
            )
        }
    }
    ...
    pub fn localize_th(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                CharacterVoiceSubtitleExcel::VT_LOCALIZE_TH,
                None,
            )
        }
    }
    ...
    pub fn localize_tw(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                CharacterVoiceSubtitleExcel::VT_LOCALIZE_TW,
                None,
            )
        }
    }
    ...
    pub fn localize_en(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                CharacterVoiceSubtitleExcel::VT_LOCALIZE_EN,
                None,
            )
        }
    }
