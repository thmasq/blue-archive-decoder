...
impl<'a> VoiceSpineExcel<'a> {
    ...
    pub fn unique_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(VoiceSpineExcel::VT_UNIQUE_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn id(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(VoiceSpineExcel::VT_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
        ...
        unsafe {
            self._tab
                .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, f32>>>(
                    VoiceSpineExcel::VT_SOUND_VOLUME,
                    None,
                )
        }
    }
