...
use super::{
    CVCollectionType, CVUnlockScenarioType, DialogCategory, DialogCondition, DialogConditionDetail,
    DialogType, ProductionStep,
};
...
impl<'a> CharacterDialogEventExcel<'a> {
    ...
    pub const VT_ORIGINAL_CHARACTER_ID: ::flatbuffers::VOffsetT = 6;
    pub const VT_DISPLAY_ORDER: ::flatbuffers::VOffsetT = 8;
    pub const VT_EVENT_ID: ::flatbuffers::VOffsetT = 10;
    pub const VT_PRODUCTION_STEP: ::flatbuffers::VOffsetT = 12;
    pub const VT_DIALOG_CATEGORY: ::flatbuffers::VOffsetT = 14;
    pub const VT_DIALOG_CONDITION: ::flatbuffers::VOffsetT = 16;
    pub const VT_DIALOG_CONDITION_DETAIL: ::flatbuffers::VOffsetT = 18;
    pub const VT_DIALOG_CONDITION_DETAIL_VALUE: ::flatbuffers::VOffsetT = 20;
    ...
    pub const VT_COLLECTION_VISIBLE: ::flatbuffers::VOffsetT = 46;
    pub const VT_CV_COLLECTION_TYPE: ::flatbuffers::VOffsetT = 48;
    pub const VT_CV_UNLOCK_SCENARIO_TYPE: ::flatbuffers::VOffsetT = 50;
    pub const VT_UNLOCK_EVENT_SEASON: ::flatbuffers::VOffsetT = 52;
    pub const VT_SCENARIO_GROUP_ID: ::flatbuffers::VOffsetT = 54;
    pub const VT_LOCALIZE_CV_GROUP: ::flatbuffers::VOffsetT = 56;
    ...
    pub fn costume_unique_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(CharacterDialogEventExcel::VT_COSTUME_UNIQUE_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn original_character_id(&self) -> i64 {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<i64>(CharacterDialogEventExcel::VT_ORIGINAL_CHARACTER_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn display_order(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(CharacterDialogEventExcel::VT_DISPLAY_ORDER, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn event_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(CharacterDialogEventExcel::VT_EVENT_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn production_step(&self) -> ProductionStep {
        ...
        unsafe {
            self._tab
                .get::<ProductionStep>(
                    CharacterDialogEventExcel::VT_PRODUCTION_STEP,
    ...
    pub fn dialog_category(&self) -> DialogCategory {
        ...
        unsafe {
            self._tab
                .get::<DialogCategory>(
                    CharacterDialogEventExcel::VT_DIALOG_CATEGORY,
    ...
    pub fn dialog_condition(&self) -> DialogCondition {
        ...
        unsafe {
            self._tab
                .get::<DialogCondition>(
                    CharacterDialogEventExcel::VT_DIALOG_CONDITION,
    ...
    #[inline]
    pub fn dialog_condition_detail(&self) -> DialogConditionDetail {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<DialogConditionDetail>(
                    CharacterDialogEventExcel::VT_DIALOG_CONDITION_DETAIL,
                    Some(DialogConditionDetail::None),
                )
                .unwrap()
        }
    }
    #[inline]
    pub fn dialog_condition_detail_value(&self) -> i64 {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<i64>(
                    CharacterDialogEventExcel::VT_DIALOG_CONDITION_DETAIL_VALUE,
                    Some(0),
                )
                .unwrap()
        }
    ...
    pub fn group_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(CharacterDialogEventExcel::VT_GROUP_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn dialog_type(&self) -> DialogType {
        ...
        unsafe {
            self._tab
                .get::<DialogType>(
                    CharacterDialogEventExcel::VT_DIALOG_TYPE,
                    Some(DialogType::Talk),
                )
                .unwrap()
        }
    }
    ...
    pub fn action_name(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                CharacterDialogEventExcel::VT_ACTION_NAME,
                None,
            )
        }
    }
    ...
    pub fn duration(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(CharacterDialogEventExcel::VT_DURATION, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn duration_kr(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(CharacterDialogEventExcel::VT_DURATION_KR, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn animation_name(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                CharacterDialogEventExcel::VT_ANIMATION_NAME,
                None,
            )
        }
    }
    ...
    pub fn localize_kr(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                CharacterDialogEventExcel::VT_LOCALIZE_KR,
                None,
            )
        }
    }
    ...
    pub fn localize_jp(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                CharacterDialogEventExcel::VT_LOCALIZE_JP,
                None,
            )
        }
    }
    ...
    pub fn localize_th(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                CharacterDialogEventExcel::VT_LOCALIZE_TH,
                None,
            )
        }
    }
    ...
    pub fn localize_tw(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                CharacterDialogEventExcel::VT_LOCALIZE_TW,
                None,
            )
        }
    }
    ...
    pub fn localize_en(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                CharacterDialogEventExcel::VT_LOCALIZE_EN,
                None,
            )
        }
    }
        ...
        unsafe {
            self._tab
                .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u32>>>(
                    CharacterDialogEventExcel::VT_VOICE_ID,
                    None,
                )
        }
    }
    ...
    pub fn collection_visible(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(
                    CharacterDialogEventExcel::VT_COLLECTION_VISIBLE,
                    Some(false),
                )
                .unwrap()
        }
        ...
        unsafe {
            self._tab
                .get::<CVCollectionType>(
                    CharacterDialogEventExcel::VT_CV_COLLECTION_TYPE,
    ...
    #[inline]
    pub fn cv_unlock_scenario_type(&self) -> CVUnlockScenarioType {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<CVUnlockScenarioType>(
                    CharacterDialogEventExcel::VT_CV_UNLOCK_SCENARIO_TYPE,
                    Some(CVUnlockScenarioType::Main),
                )
                .unwrap()
        }
    }
    #[inline]
    pub fn unlock_event_season(&self) -> i64 {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<i64>(CharacterDialogEventExcel::VT_UNLOCK_EVENT_SEASON, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn scenario_group_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(CharacterDialogEventExcel::VT_SCENARIO_GROUP_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn localize_cv_group(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                CharacterDialogEventExcel::VT_LOCALIZE_CV_GROUP,
                None,
            )
        }
    }
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<i64>(
                ...
                Self::VT_ORIGINAL_CHARACTER_ID,
                false,
            )?
            .visit_field::<i64>("display_order", Self::VT_DISPLAY_ORDER, false)?
            .visit_field::<i64>("event_id", Self::VT_EVENT_ID, false)?
            ...
            .visit_field::<DialogConditionDetail>(
                "dialog_condition_detail",
                Self::VT_DIALOG_CONDITION_DETAIL,
                false,
            )?
            .visit_field::<i64>(
                "dialog_condition_detail_value",
                Self::VT_DIALOG_CONDITION_DETAIL_VALUE,
                false,
            )?
            ...
            .visit_field::<CVUnlockScenarioType>(
                "cv_unlock_scenario_type",
                Self::VT_CV_UNLOCK_SCENARIO_TYPE,
                false,
            )?
            .visit_field::<i64>("unlock_event_season", Self::VT_UNLOCK_EVENT_SEASON, false)?
...
impl Serialize for CharacterDialogEventExcel<'_> {
        ...
        S: Serializer,
    {
        ...
        s.serialize_field("original_character_id", &self.original_character_id())?;
        ...
        s.serialize_field("dialog_condition_detail", &self.dialog_condition_detail())?;
        s.serialize_field(
            "dialog_condition_detail_value",
            &self.dialog_condition_detail_value(),
        )?;
        ...
        s.serialize_field("cv_unlock_scenario_type", &self.cv_unlock_scenario_type())?;
        s.serialize_field("unlock_event_season", &self.unlock_event_season())?;
...
impl ::core::fmt::Debug for CharacterDialogEventExcel<'_> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        ...
        ds.field("original_character_id", &self.original_character_id());
        ...
        ds.field("dialog_condition_detail", &self.dialog_condition_detail());
        ds.field(
            "dialog_condition_detail_value",
            &self.dialog_condition_detail_value(),
        );
        ...
        ds.field("cv_unlock_scenario_type", &self.cv_unlock_scenario_type());
        ds.field("unlock_event_season", &self.unlock_event_season());
